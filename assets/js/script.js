...
const applicationsShowCases = [
  {
    logo: "./assets/images/projects/gift-city/gift-city-logo.png",
    name: "GIFT Utilities",
    description:
      "Utility Billing and Customer Service System for the Government of India",
    screenshot: "./assets/images/projects/gift-city/home-screen.png",
    googlePlay: "https://2ly.link/2AfMo",
    appStore: "https://2ly.link/2AfMw",
    website: "https://2ly.link/2AfOk",
    secoundWebsite: "https://2ly.link/2AfOB",
  },
  {
    logo: "./assets/images/projects/enbiosis/enbiosis-logo.png",
    name: "Enbiosis",
    description:
      "AI-Powered Personalized Healthcare, Microbiome & Nutrition App",
    screenshot: "./assets/images/projects/enbiosis/home-screen.png",
    googlePlay: "https://linkly.link/2AfSb",
    website: "https://2ly.link/2AfUz",
    appStore: "https://2ly.link/2AfTx",
  },
  {
    logo: "./assets/images/projects/virtual-ref/virtual-ref-logo.png",
    name: "Virtual Ref",
    description: "AI-Driven Fitness & Pose Detection App",
    screenshot: "./assets/images/projects/virtual-ref/home-screen.png",
    internalOnly: true,
  },
  {
    logo: "./assets/images/projects/bas-recovery/bas-recovery-logo.png",
    name: "BasRecovery",
    description: "On-Demand Roadside Help App for Drivers Across the UAE",
    screenshot: "./assets/images/projects/bas-recovery/home-screen.png",
    googlePlay: "https://linkly.link/2C0lG",
    appStore: "https://linkly.link/2C0lK",
    website: "https://linkly.link/2C0lL",
  },
  {
    logo: "./assets/images/projects/noorah/noorah-logo.png",
    name: "Noorah",
    description: "Chakra Assessment and Wellness App for Personalized Healing",
    screenshot: "./assets/images/projects/noorah/home-screen.png",
    personalOnly: true,
  },
  {
    logo: "./assets/images/projects/tulagram/tulagram-logo.png",
    name: "Tulagram",
    description: "Tulip Bouquet Ordering & Delivery App",
    screenshot: "./assets/images/projects/tulagram/home-screen.png",
    googlePlay: "https://2ly.link/26KSU",
    website: "https://tulagram.com/",
    appStore: "https://2ly.link/26KSV",
  },
  {
    logo: "./assets/images/projects/ok-kosher/ok-kosher-logo.png",
    name: "OK Kosher",
    description: "Kosher Product Database App",
    screenshot: "./assets/images/projects/ok-kosher/home-screen.png",
    googlePlay: "https://2ly.link/2AfeR",
    appStore: "https://2ly.link/2Afdz",
  },
];
...
function createMobileCreations(items, containerId) {
  const container = document.getElementById(containerId);
  if (!container) return;
  ...
  items.forEach((item) => {
    ...
    const name = item.name || "Untitled App";
    const description = item.description || "";
    const logo = item.logo || "./assets/images/default-logo.png";
    const screenshot =
      item.screenshot || "./assets/images/default-screenshot.png";
    ...
    if (item.inProgress) {
      linksHtml = `
        <span class="status-label in-progress">
          ...
          <span>In Progress – Under Development</span>
        </span>`;
    } else if (item.internalOnly) {
      linksHtml = `
        <span class="status-label internal-use">
          <span class="icon">🔒</span>
          <span>Internal Use Only</span>
        </span>`;
    } else if (item.personalOnly) {
      linksHtml = `
        <span class="status-label personal-use">
          <span class="icon">👤</span>
      ...
      linksHtml = `
        ${createLink(
          item.appStore,
          `<img src="./assets/images/svg/app-store.svg" alt="App Store" loading="lazy">`
        )}
        ${createLink(
          item.googlePlay,
          `<img src="./assets/images/svg/google-play.png" alt="Google Play" loading="lazy">`
        )}
        ${createLink(
          item.website,
          `<ion-icon name="globe-outline" aria-label="Website"></ion-icon>`
        )}
      `;
    }
    ...
    listItem.innerHTML = `
      <div class="showcase-content">
        <div class="showcase-header">
          <img src="${logo}" alt="${name} Logo" class="showcase-logo" loading="lazy">
          <div class="showcase-text">
            <h4 class="h4 showcase-title">${escapeHTML(name)}</h4>
          </div>
        </div>
        <p class="showcase-description">${escapeHTML(description)}</p>
        <div class="showcase-links">
          ${linksHtml}
        </div>
      </div>
      <figure class="showcase-banner">
...
function createLink(href, contentHtml) {
  return href
    ? `<span class="store-link"><a href="${href}" target="_blank" rel="noopener noreferrer">${contentHtml}</a></span>`
    : "";
}
...
createMobileCreations(applicationsShowCases, "mobile-creations-list");
